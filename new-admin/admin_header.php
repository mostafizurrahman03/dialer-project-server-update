...
$SSstd_row1_background='B8B8B8';
$SSstd_row2_background='D4D4D4';
...
if ($SSadmin_screen_colors != 'default')
	...
	if ($colors_ct > 0)
		...
		$SSstd_row2_background ='D4D4D4';//	$row[3];
...
$selected_small_logo = "images/srglogo.jpg";
$logo_new=0;
$logo_old=0;
$logo_small_old=0;
if (file_exists('images/srglogo.jpg')) {$logo_new++;}
if (file_exists('srglogo.jpg')) {$logo_small_old++;}
if (file_exists('srglogo.jpg')) {$logo_old++;}
if ($SSweb_logo=='default_new')
	{
	$selected_logo = "images/srglogo.jpg";
	$selected_small_logo = "images/srglogo.jpg";
	}
if ( ($SSweb_logo=='default_old') and ($logo_old > 0) )
	{
	$selected_logo = "srglogo.jpg";
	$selected_small_logo = "srglogo.jpg";
	}
if ( ($SSweb_logo!='default_new') and ($SSweb_logo!='default_old') )
	{
	if (file_exists("images/srglogo.jpg")) 
		{
		$selected_logo = "images/srglogo.jpg";
		$selected_small_logo = "images/srglogo.jpg";
		}
...
if ( ($SSadmin_modify_refresh > 1) and (preg_match("/^3|^4/",$ADD)) )
	{
	echo "<BODY class='hold-transition sidebar-mini' onLoad=\"modify_refresh_display();\">\n";
	}
else
	{
...
<div class="wrapper">
  ...
  <style>
    ...
    .premium-navbar {
        ...
        z-index: 1040; /* Standard Bootstrap navbar z-index */
    }
    .premium-nav-link {
    ...
    .premium-nav-link:hover, .premium-nav-link:focus {
    ...
    .premium-time-container:hover {
        background: rgba(0, 0, 0, 0.3);
        border-color: rgba(255, 255, 255, 0.25);
        box-shadow: inset 0 2px 5px rgba(0,0,0,0.3), 0 4px 10px rgba(0,0,0,0.1);
    }
    .premium-time-container i {
    ...
    /* Optional: Active link state with sky theme */
    .premium-nav-link.active {
        background: var(--sky-darker);
        border-color: rgba(255, 255, 255, 0.3);
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2);
    }
</style>	<nav class="main-header navbar navbar-expand premium-navbar">
    	<!-- Left navbar links -->
		<ul class="navbar-nav align-items-center">
		<li class="nav-item">
			<a class="nav-link premium-hamburger" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
		</li>
		<li class="nav-item d-none d-sm-inline-block ml-2">
			<a href="<?php echo $admin_home_url_LU ?>" class="nav-link premium-nav-link"><i class="fas fa-home"></i> <span><?php echo _QXZ("HOME"); ?></span></a>
		</li>
		<li class="nav-item d-none d-sm-inline-block">
			<a href=".agent/timeclock.php?referrer=admin" class="nav-link premium-nav-link"><i class="fas fa-user-clock"></i> <span><?php echo _QXZ("Timeclock"); ?></span></a>
		</li>
		<li class="nav-item d-none d-sm-inline-block">
			<a href="manager_chat_interface.php" class="nav-link premium-nav-link"><i class="fas fa-comments"></i> <span><?php echo _QXZ("Chat"); ?></span></a>
		</li>
		<?php if ($SSenable_languages == '1')	{ ?>
		<li class="nav-item d-none d-sm-inline-block">
			<a href="<?php echo $ADMIN ?>?ADD=999989" class="nav-link premium-nav-link"><i class="fas fa-globe"></i> <span><?php echo _QXZ("Change language"); ?></span></a>
		</li>
		<?php } ?>
		</ul>
		...
		<li class="nav-item d-flex align-items-center pr-2">
			<div class="premium-time-container" title="Current Server Time">
  ...
  <style>
    :root {
        --sky-light: rgba(224, 242, 254, 0.7);
        --sky-medium: rgba(186, 230, 253, 0.8);
        --sky-primary: #0ea5e9;
        --sky-dark: #0284c7;
        --sky-darker: #0c4a6e;
        --sky-gradient: linear-gradient(135deg, #38bdf8, #0284c7, #0ea5e9);
        --sky-gradient-active: linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%);
        --white: #ffffff;
        --sidebar-bg: rgba(255, 255, 255, 0.85);
        --glass-border: rgba(255, 255, 255, 0.4);
        --subtle-shadow: 0 8px 32px 0 rgba(2, 132, 199, 0.1);
        --glow-shadow: 0 4px 15px rgba(14, 165, 233, 0.4);
    }
    
    /* Main Sidebar Container - X-axis & Bottom line fix */
    .sidebar-sky-custom {
    ...
    .sidebar-sky-custom::-webkit-scrollbar {
        width: 5px;
        height: 0; /* Horizontal scrollbar completely disabled */
    }
    
    .sidebar-sky-custom::-webkit-scrollbar-track {
        background: transparent;
        border-bottom: none !important;
        margin-bottom: 0 !important;
    }
    
    .sidebar-sky-custom::-webkit-scrollbar-thumb {
        background: rgba(14, 165, 233, 0.3);
        border-radius: 10px;
    }
    
    .sidebar-sky-custom::-webkit-scrollbar-thumb:hover {
        background: rgba(14, 165, 233, 0.6);
    }
    
    /* Hide horizontal scrollbar completely */
    .sidebar-sky-custom::-webkit-scrollbar:horizontal {
    ...
    /* Remove any pseudo-elements that might create bottom line */
    .sidebar-sky-custom::after,
    .sidebar-sky-custom::before {
        display: none !important;
        content: none !important;
    }
    
    /* Sidebar inner container */
    .sidebar-sky-custom .sidebar {
        overflow-x: hidden !important;
        border-bottom: none !important;
        margin-bottom: 0 !important;
        padding-bottom: 0 !important;
    ...
    .sidebar-sky-custom .brand-link::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 10%;
    ...
    .sidebar-sky-custom .brand-link:hover {
        background: rgba(255,255,255,0.5);
        text-shadow: 0 0 10px rgba(14,165,233,0.2);
    }
    
    /* User Panel Area */
    .sidebar-sky-custom .user-panel {
        border-bottom: none !important;
        padding: 1rem 0;
        position: relative;
        overflow-x: hidden !important;
    ...
    .sidebar-sky-custom .user-panel::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 10%;
    ...
    .sidebar-sky-custom .user-panel .info a {
    ...
    .sidebar-sky-custom .user-panel .info a:hover {
        color: var(--sky-primary) !important;
        letter-spacing: 1px;
    }
    
    /* Main Navigation Links */
    .sidebar-sky-custom .nav-sidebar > .nav-item > .nav-link {
        color: var(--sky-darker) !important;
        border-radius: 14px;
        margin: 6px 14px;
        padding: 12px 15px;
    ...
    .sidebar-sky-custom .nav-sidebar > .nav-item > .nav-link i {
        flex-shrink: 0 !important;
    }
    
    .sidebar-sky-custom .nav-sidebar > .nav-item > .nav-link p {
        flex: 1;
        margin: 0;
        overflow: hidden;
    ...
    .sidebar-sky-custom .nav-sidebar > .nav-item:not(.menu-open) > .nav-link:hover {
    ...
    /* Active Main Links with Gradient */
    .sidebar-sky-custom .nav-sidebar > .nav-item > .nav-link.active,
    .sidebar-sky-custom .nav-sidebar > .nav-item.menu-open > .nav-link.active {
        background: var(--sky-gradient-active) !important;
    ...
    .sidebar-sky-custom .nav-sidebar > .nav-item > .nav-link.active i {
        color: var(--white) !important;
        filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));
    }
    
    /* Right arrow icon */
    .sidebar-sky-custom .nav-link .right {
        margin-left: auto !important;
        flex-shrink: 0 !important;
    }
    
    /* Sub-menu styling */
    .sidebar-sky-custom .nav-treeview {
    ...
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link {
        color: var(--sky-dark) !important;
    ...
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link::before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
    ...
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link:hover::before {
        width: 100%;
    }
    
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link:hover {
        color: var(--sky-primary) !important;
        transform: translateX(6px);
    }
    
    /* Active Sub-menu Links */
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link.active {
        background: var(--white) !important;
        color: var(--sky-primary) !important;
        font-weight: 700;
        box-shadow: 0 4px 10px rgba(14, 165, 233, 0.15) !important;
        border-left: 4px solid var(--sky-primary) !important;
        padding-left: 8px;
    }
    
    .sidebar-sky-custom .nav-treeview > .nav-item > .nav-link.active i {
        color: var(--sky-primary) !important;
    }
    
    /* Icons General Styling */
    .sidebar-sky-custom .nav-sidebar .nav-link i {
        color: var(--sky-primary);
        transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
    }
    
    .sidebar-sky-custom .nav-sidebar .nav-link:hover i {
        color: var(--sky-dark);
        transform: scale(1.2) translateY(-2px);
    }
    
    /* Ensure no bottom line appears from any element */
    .sidebar-sky-custom .nav-sidebar {
        margin-bottom: 0 !important;
        padding-bottom: 0 !important;
        overflow-x: hidden !important;
    }
    
    .sidebar-sky-custom .nav-item {
        overflow-x: hidden !important;
    }
    
    /* Last child margin/padding remove */
    .sidebar-sky-custom .nav-sidebar:last-child,
    .sidebar-sky-custom .sidebar nav:last-child,
    .sidebar-sky-custom .sidebar > :last-child {
        margin-bottom: 0 !important;
        padding-bottom: 0 !important;
    }
    ...
    .sidebar-sky-custom .nav-item.menu-open {
        overflow-x: hidden !important;
    }
</style>  <aside class="main-sidebar sidebar-sky-custom elevation-4">
    <!-- Brand Logo -->
<A HREF="admin.php"><IMG SRC="<?php echo $selected_logo; ?>" ALT="System logo" height="50" width="150" style="margin-left:50px;"><?php /*?>&nbsp;&nbsp;&nbsp;
 <span class="brand-text font-weight-light"><strong><?php echo _QXZ("ADMIN"); ?></strong></span><?php */?>
</A>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="<?php echo $ADMIN ?>?force_logout=1" class="d-block"><?php echo _QXZ("Logout"); ?> (<?php echo $PHP_AUTH_USER ?>)</a> 
        </div>
    </div>
	...
	?>
          <!-- REPORTS NAVIGATION -->
          <li class="nav-item">
            <a href="<?php echo $ADMIN ?>?ADD=999999" class="nav-link <?php if($ADD==999999){?> active<?php } ?>" <?php //if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=999999';\"";} ?>>
            ...
            <!-- REPORTS NAVIGATION -->  
            <!-- USERS NAVIGATION -->
          <li class="nav-item <?php if ( ($ADD=='0A') or ($ADD==1) or ($ADD=='1A') or ($ADD==550) or (basename($_SERVER['SCRIPT_NAME'])=='user_stats.php') or (basename($_SERVER['SCRIPT_NAME'])=='user_status.php') or (basename($_SERVER['SCRIPT_NAME'])=='AST_agent_time_sheet.php') or (basename($_SERVER['SCRIPT_NAME'])=='user_territories.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_user_list_new.php') ){?> menu-open<?php } ?>">
          
            <a href="#" class="nav-link <?php if ( ($ADD=='0A') or ($ADD==1) or ($ADD=='1A') or ($ADD==550) or (basename($_SERVER['SCRIPT_NAME'])=='user_stats.php') or (basename($_SERVER['SCRIPT_NAME'])=='user_status.php') or (basename($_SERVER['SCRIPT_NAME'])=='AST_agent_time_sheet.php') or (basename($_SERVER['SCRIPT_NAME'])=='user_territories.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_user_list_new.php') ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=0A" class="nav-link <?php if($ADD=='0A'){?> active<?php } ?>">
              ...
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1" class="nav-link <?php if($ADD=='1'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New User"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1A" class="nav-link <?php if($ADD=='1A'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
              ...
              <?php } ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=550" class="nav-link <?php if($ADD=='550'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Search For A User"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="user_stats.php?user=<?php echo $user ?>" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='user_stats.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("User Stats"); ?></p>
                </a>
              </li>
               <li class="nav-item">
               <a href="user_status.php?user=<?php echo $user ?>" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='user_status.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("User Status"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="AST_agent_time_sheet.php?agent=<?php echo $user ?>" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='AST_agent_time_sheet.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
	...
	if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
		{ ?>
         <li class="nav-item">
                <a href="user_territories.php?agent=<?php echo $user ?>" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='user_territories.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
            ...
            { ?>
			  <li class="nav-item">
                <a href="admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='admin_user_list_new.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
       ...
       <li class="nav-item <?php if ( ($ADD==10) or ($ADD==32) or ($ADD==33) or ($ADD==35) or ($ADD==36) or ($ADD==39) or ($ADD==37) or ($ADD==301) or ($ADD==302) ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==10) or ($ADD==32) or ($ADD==33) or ($ADD==35) or ($ADD==36) or ($ADD==39) or ($ADD==37) or ($ADD==301) or ($ADD==302) ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=10" class="nav-link <?php if($ADD=='10'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Campaigns Main"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=32" class="nav-link <?php if($ADD=='32'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Statuses"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=33" class="nav-link <?php if($ADD=='33'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("HotKeys"); ?></p>
                </a>
              </li>
              <?php if ($SSoutbound_autodial_active > 0) {?>
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=35" class="nav-link <?php if($ADD=='35'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Lead Recycle"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=36" class="nav-link <?php if($ADD=='36'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Auto-Alt Dial"); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=39" class="nav-link <?php if($ADD=='39'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("List Mix"); ?></p>
                </a>
              </li>
              <?php } ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=37" class="nav-link <?php if($ADD=='37'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Pause Codes"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=301" class="nav-link <?php if($ADD=='301'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Presets"); ?></p>
                </a>
              </li>
              <?php if ($SScampaign_cid_areacodes_enabled > 0) {?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=302" class="nav-link <?php if($ADD=='302'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("AC-CID"); ?></p>
                </a>
              </li>
               <?php } ?>
       		 </ul>
       ...
       <!-- LISTS NAVIGATION -->
		 ...
		 if ($SSoutbound_autodial_active > 0){	?>
          <li class="nav-item <?php if ( ($ADD=='100') or ($ADD==111) or ($ADD=='121') or ($ADD==130) or (basename($_SERVER['SCRIPT_NAME'])=='admin_search_lead.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_modify_lead.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_listloader_fourth_gen.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_lists_custom.php?action=COPY_FIELDS_FORM') ){?> menu-open<?php } ?>">
          
            <a href="#" class="nav-link <?php if ( ($ADD=='100') or ($ADD==111) or ($ADD=='121') or ($ADD==130) or (basename($_SERVER['SCRIPT_NAME'])=='admin_search_lead.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_modify_lead.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_listloader_fourth_gen.php') or (basename($_SERVER['SCRIPT_NAME'])=='admin_lists_custom.php?action=COPY_FIELDS_FORM') ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100" class="nav-link <?php if($ADD=='100'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show Lists"); ?></p>
                </a>
              </li>
             <?php if ($add_copy_disabled < 1) { ?>
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=111" class="nav-link <?php if($ADD=='111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New List"); ?></p>
                </a>
              </li>
               <?php } ?>
               <li class="nav-item">
                <a href="admin_search_lead.php" class="nav-link <?php  if(basename($_SERVER['SCRIPT_NAME'])=='admin_search_lead.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Search For A Lead"); ?></p>
                </a>
              </li>
              <li class="nav-item">
               <a href="admin_modify_lead.php"  class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='admin_modify_lead.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New Lead"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=121" class="nav-link <?php if($ADD=='121'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo $DNClink ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="admin_listloader_fourth_gen.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='admin_listloader_fourth_gen.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Load New Leads"); ?></p>
                </a>
              </li>
              <?php
			if ($SScustom_fields_enabled > 0)
				...
				?>
               <li class="nav-item">
               <a href="<?php echo $admin_lists_custom ?>" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='admin_lists_custom.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("List Custom Fields"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $admin_lists_custom ?>?action=COPY_FIELDS_FORM" class="nav-link <?php if(basename($_SERVER['REQUEST_URI'])=='admin_lists_custom.php?action=COPY_FIELDS_FORM'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Copy Custom Fields"); ?></p>
                </a>
              </li>
               <?php } ?>
        <?php
	if ($SSenable_drop_lists > 0)
		{ ?>
         <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=130" class="nav-link <?php if($ADD=='130'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Drop Lists"); ?></p>
                </a>
              </li>
        ...
        <?php } ?>
         ...
         <!-- QC navigation -->
         <li class="nav-item <?php if ( ($ADD==100000000000000) or ($ADD==341111111111111) or (basename($_SERVER['SCRIPT_NAME'])=='qc_scorecards.php') ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==100000000000000) or ($ADD==341111111111111) or (basename($_SERVER['SCRIPT_NAME'])=='qc_scorecards.php') ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=CAMPAIGN" class="nav-link <?php if(basename($_SERVER['REQUEST_URI'])=='admin.php?ADD=100000000000000&qc_display_group_type=CAMPAIGN'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("QC Calls by Campaign"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=LIST" class="nav-link <?php if(basename($_SERVER['REQUEST_URI'])=='admin.php?ADD=100000000000000&qc_display_group_type=LIST'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("QC Calls by List"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=INGROUP" class="nav-link <?php if(basename($_SERVER['REQUEST_URI'])=='admin.php?ADD=100000000000000&qc_display_group_type=INGROUP'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("QC Calls by Ingroup"); ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-link <?php if(basename($_SERVER['REQUEST_URI'])=='admin.php?ADD=100000000000000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Enter QC Queue");  ?></p>
                </a>
              </li>
              
              <li class="nav-item">
                <a href="qc_scorecards.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='qc_scorecards.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show QC Scorecards"); ?></p>
                </a>
              </li>
              
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="nav-link <?php if($ADD=='341111111111111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Modify QC Codes");  ?></p>
                </a>
              </li>
         ...
         <!-- QC navigation -->
          <?php } ?>
         <!-- SCRIPTS NAVIGATION -->
          <li class="nav-item <?php if ( ($ADD==1000000) or ($ADD==1111111) ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==1000000) or ($ADD==1111111) ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1000000" class="nav-link <?php if($ADD=='1000000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show Scripts");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1111111" class="nav-link <?php if($ADD=='1111111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New Script");  ?></p>
                </a>
              </li>
       		 </ul>
          </li>
         ...
         <!-- FILTERS NAVIGATION -->
         <?php if ($SSoutbound_autodial_active > 0) 	{ 	?>
          <li class="nav-item <?php if ( ($ADD==10000000) or ($ADD==11111111) ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==10000000) or ($ADD==11111111) ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=10000000" class="nav-link <?php if($ADD=='10000000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show Filters");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=11111111" class="nav-link <?php if($ADD=='11111111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New Filter");  ?></p>
                </a>
              </li>
       		 </ul>
          </li>
         ...
         <!-- FILTERS NAVIGATION -->
         <!-- INGROUPS NAVIGATION -->
         <?php  	if ($LOGdelete_from_dnc > 0) {$FPGlink = _QXZ("Add-Delete FPG Number");} else {$FPGlink = _QXZ("Add FPG Number");} 		?>
		
          <li class="nav-item <?php if ( ($ADD==1000) or ($ADD==1001) or ($ADD==1111) or ($ADD==1211) or ($ADD==1800) or ($ADD==1811) or ($ADD==1911) or ($ADD==1900) or ($ADD==18111) or ($ADD==19111) or ($ADD==1311) or ($ADD==1411) or ($ADD==1320) or ($ADD==1500) or ($ADD==1511) or ($ADD==1611) or ($ADD==1700) or ($ADD==1711) or ($ADD==171) ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==1000) or ($ADD==1001) or ($ADD==1111) or ($ADD==1211) or ($ADD==1800) or ($ADD==1811) or ($ADD==1911) or ($ADD==1900) or ($ADD==18111) or ($ADD==19111) or ($ADD==1311) or ($ADD==1411) or ($ADD==1320) or ($ADD==1500) or ($ADD==1511) or ($ADD==1611) or ($ADD==1700) or ($ADD==1711) or ($ADD==171) ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
             <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1001" class="nav-link <?php if($ADD=='1001'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Inbound");  ?></p>
                </a>
              </li>
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1000" class="nav-link <?php if($ADD=='1000'){?> active<?php } ?>">
                  <?php echo $inbound_icon ?>
                  <p><?php echo _QXZ("Show In-Groups");  ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1111" class="nav-link <?php if($ADD=='1111'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add A New In-Group");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1211" class="nav-link <?php if($ADD=='1211'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Copy In-Group");  ?></p>
                </a>
              </li>
               <?php } ?>
              <?php if ($SSemail_enabled>0) {	?>
                 <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1800" class="nav-link <?php if($ADD=='1800'){?> active<?php } ?>">
                 <i class="far fa-envelope nav-icon"></i>
                  <p><?php echo _QXZ("Show Email Groups"); ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1811" class="nav-link <?php if($ADD=='1811'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add New Email Group");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1911" class="nav-link <?php if($ADD=='1911'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Copy Email Group");  ?></p>
                </a>
              </li>
              <?php } ?>
               <?php } ?>
               ...
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1900" class="nav-link <?php if($ADD=='1900'){?> active<?php } ?>">
              ...
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=18111" class="nav-link <?php if($ADD=='18111'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add New Chat Group");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=19111" class="nav-link <?php if($ADD=='19111'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Copy Chat Group");  ?></p>
                </a>
              </li>
               <?php } ?>
               <?php } ?>
               ...
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1300" class="nav-link <?php if($ADD=='1300'){?> active<?php } ?>">
                 <i class="far fa-file-archive nav-icon"></i>
                  <p><?php echo _QXZ("Show DIDs"); ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1311" class="nav-link <?php if($ADD=='1311'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add New DID");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1411" class="nav-link <?php if($ADD=='1411'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Copy DID");  ?></p>
                </a>
              </li>
               <?php } ?>
              <?php if ($SSdid_ra_extensions_enabled > 0) {	?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1320" class="nav-link <?php if($ADD=='1320'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("RA Extensions");  ?></p>
                </a>
              </li>
                <?php } ?>
                
                 <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1500" class="nav-link <?php if($ADD=='1500'){?> active<?php } ?>">
                 <i class="far fa-calendar nav-icon"></i>
                  <p><?php echo _QXZ("Show Call Menus"); ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1511" class="nav-link <?php if($ADD=='1511'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add New Call Menu");  ?></p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1611" class="nav-link <?php if($ADD=='1611'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Copy Call Menu");  ?></p>
                </a>
              </li>
               <?php } ?>
               
                <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=1700" class="nav-link <?php if($ADD=='1700'){?> active<?php } ?>">
                 <i class="far fa-clipboard nav-icon"></i>
                  <p><?php echo _QXZ("Filter Phone Groups"); ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=1711" class="nav-link <?php if($ADD=='1711'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p><?php echo _QXZ("Add Filter Phone Groups");  ?></p>
                </a>
              </li>
			  <?php } ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=171" class="nav-link <?php if($ADD=='171'){?> active<?php } ?>">
                  <i class="far fa-dddd nav-icon"></i>
                  <p> <?php echo $FPGlink ?></p>
                </a>
              </li>
         ...
         <!-- USERGROUPS NAVIGATION -->
          <li class="nav-item <?php if ( ($ADD==100000) or ($ADD==111111)  or (basename($_SERVER['SCRIPT_NAME'])=='user_group_bulk_change.php')  or (basename($_SERVER['SCRIPT_NAME'])=='group_hourly_stats.php') ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==100000) or ($ADD==111111)  or (basename($_SERVER['SCRIPT_NAME'])=='user_group_bulk_change.php')  or (basename($_SERVER['SCRIPT_NAME'])=='group_hourly_stats.php')  ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=100000" class="nav-link <?php if($ADD=='100000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show User Groups");  ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=111111" class="nav-link <?php if($ADD=='111111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add A New User Group");  ?></p>
                </a>
              </li>
               <?php } ?>
                <li class="nav-item">
               <a href="group_hourly_stats.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='group_hourly_stats.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Group Hourly Report"); ?></p>
                </a>
              </li>
               <li class="nav-item">
               <a href="user_group_bulk_change.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='user_group_bulk_change.php'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Bulk Group Change"); ?></p>
                </a>
              </li>
       		 </ul>
          </li>
         ...
         <!-- REMOTEAGENTS NAVIGATION -->
          <li class="nav-item <?php if ( ($ADD==10000) or ($ADD==11111)  or ($ADD==12000) or ($ADD==12111) ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==10000) or ($ADD==11111)  or ($ADD==12000) or ($ADD==12111)  ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=10000" class="nav-link <?php if($ADD=='10000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show Remote Agents");  ?></p>
                </a>
              </li>
              <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=11111" class="nav-link <?php if($ADD=='11111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add New Remote Agent");  ?></p>
                </a>
              </li>
               <?php } ?>
                <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=12000" class="nav-link <?php if($ADD=='12000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show Extension Groups");  ?></p>
                </a>
              </li>
               <?php if ($add_copy_disabled < 1) { ?>
               <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=12111" class="nav-link <?php if($ADD=='12111'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Add Extension Group");  ?></p>
                </a>
              </li>
               <?php } ?>
       		 </ul>
         ...
         <!-- REMOTEAGENTS NAVIGATION -->
         <!-- ADMIN NAVIGATION -->
          <li class="nav-item <?php if ( ($ADD==100000000) or ($ADD==130000000) or ($ADD==10000000000) or ($ADD==130000000000) or ($ADD==140000000000) or ($ADD==100000000000) or ($ADD==1000000000000) or ($ADD==311111111111111) or ($ADD==180000000000) or ($ADD==182000000000) or ($ADD==321111111111111) or ($ADD==193000000000) or ($ADD==196000000000) or ($ADD==170000000000) or ($ADD==160000000000) or ($ADD==163000000000) or ($ADD==162000000000) or ($ADD==197000000000) or ($ADD==150000000000) or ($ADD==190000000000) or ($ADD==192000000000) or ($ADD==194000000000) or ($ADD==195000000000) or (basename($_SERVER['SCRIPT_NAME'])=='admin_email_accounts.php') or (basename($_SERVER['SCRIPT_NAME'])=='audio_store.php') or (basename($_SERVER['SCRIPT_NAME'])=='callcard_admin.php') ){?> menu-open<?php } ?>">
       
            <a href="#" class="nav-link <?php if ( ($ADD==100000000) or ($ADD==130000000) or ($ADD==10000000000) or ($ADD==130000000000) or ($ADD==140000000000) or ($ADD==100000000000) or ($ADD==1000000000000) or ($ADD==311111111111111) or ($ADD==180000000000) or ($ADD==182000000000) or ($ADD==321111111111111) or ($ADD==193000000000) or ($ADD==196000000000) or ($ADD==170000000000) or ($ADD==160000000000) or ($ADD==163000000000) or ($ADD==162000000000) or ($ADD==197000000000) or ($ADD==150000000000) or ($ADD==190000000000) or ($ADD==192000000000) or ($ADD==194000000000) or ($ADD==195000000000) or (basename($_SERVER['SCRIPT_NAME'])=='admin_email_accounts.php') or (basename($_SERVER['SCRIPT_NAME'])=='audio_store.php') or (basename($_SERVER['SCRIPT_NAME'])=='callcard_admin.php')  ){?> active<?php } ?>">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
               <a href="<?php echo $ADMIN ?>?ADD=999998" class="nav-link <?php if($ADD=='999998'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("All Admin");  ?></p>
                </a>
              </li>
              
             <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=100000000" class="nav-link <?php if($ADD=='100000000'){?> active<?php } ?>"><p><img src="images/icon_calltimes.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Call Times"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=130000000" class="nav-link <?php if($ADD=='130000000'){?> active<?php } ?>"><p><img src="images/icon_shifts.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Shifts"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=10000000000" class="nav-link <?php if($ADD=='10000000000'){?> active<?php } ?>"><p><img src="images/icon_phones.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Phones"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=130000000000" class="nav-link <?php if($ADD=='130000000000'){?> active<?php } ?>"><p><img src="images/icon_templates.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Templates"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=140000000000" class="nav-link <?php if($ADD=='140000000000'){?> active<?php } ?>"><p><img src="images/icon_carriers.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Carriers"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000" class="nav-link <?php if($ADD=='100000000000'){?> active<?php } ?>"><p><img src="images/icon_servers.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Servers"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=1000000000000" class="nav-link <?php if($ADD=='1000000000000'){?> active<?php } ?>"><p><img src="images/icon_conferences.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Conferences"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=311111111111111" class="nav-link <?php if($ADD=='311111111111111'){?> active<?php } ?>"><p><img src="images/icon_settings.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("System Settings"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=180000000000" class="nav-link <?php if($ADD=='180000000000'){?> active<?php } ?>"><p><img src="images/icon_screenlabels.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Screen Labels"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=182000000000" class="nav-link <?php if($ADD=='182000000000'){?> active<?php } ?>"><p><img src="images/icon_screencolors.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Screen Colors"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=321111111111111" class="nav-link <?php if($ADD=='321111111111111'){?> active<?php } ?>"><p><img src="images/icon_statuses.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("System Statuses"); ?></p></a></li>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=193000000000" class="nav-link <?php if($ADD=='193000000000'){?> active<?php } ?>"><p><img src="images/icon_statusgroups.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Status Groups"); ?></p></a></li>
<?php 	if ($SScampaign_cid_areacodes_enabled > 0)	{	?>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=196000000000" class="nav-link <?php if($ADD=='196000000000'){?> active<?php } ?>"><p><img src="images/icon_cidgroups.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("CID Groups"); ?></p></a></li>
<?php } ?>
<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=170000000000" class="nav-link <?php if($ADD=='170000000000'){?> active<?php } ?>"><p><img src="images/icon_voicemail.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Voicemail"); ?></p></a></li>
<?php if ($SSemail_enabled > 0) { ?>
<li class="nav-item">
               <a href="admin_email_accounts.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='admin_email_accounts.php'){?> active<?php } ?>">
                
                  <p><img src="images/icon_email.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Email Accounts"); ?></p>
                </a>
              </li>
...
<?php if ( ($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0) ){ ?>
	<li class="nav-item">
           <a href="audio_store.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='audio_store.php'){?> active<?php } ?>">
        <p><img src="images/icon_audiostore.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Audio Store"); ?></p>
     	 </a>
    </li>
              
     <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=160000000000" class="nav-link <?php if($ADD=='160000000000'){?> active<?php } ?>"><p><img src="images/icon_musiconhold.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Music On Hold"); ?></p></a></li> 
     
     <?php if ($SSenable_languages > 0) { ?>
     <li class="nav-item"><a href="admin_languages.php?ADD=163000000000"class="nav-link <?php if($ADD=='163000000000'){?> active<?php } ?>"><p><img src="images/icon_languages.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Languages"); ?></p></a></li>
     <?php } ?>
   <?php if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) ) {?>  
    <li class="nav-item"><a href="admin_soundboard.php?ADD=162000000000" class="nav-link <?php if($ADD=='162000000000'){?> active<?php } ?>"><p><img src="images/icon_audiosoundboards.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Audio Soundboards"); ?></p></a></li>
     
     <?php } ?>  
     
       <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=197000000000" class="nav-link <?php if($ADD=='197000000000'){?> active<?php } ?>"><p><img src="images/icon_vm_messages.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("VM Message Groups"); ?></p></a></li>
           
<?php } ?>
 <?php if ($SSenable_tts_integration > 0){ ?>
 <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=150000000000" class="nav-link <?php if($ADD=='150000000000'){?> active<?php } ?>"><p><img src="images/icon_texttospeech.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Text To Speech"); ?></p></a></li>

<?php } ?>

<?php if ($SScallcard_enabled > 0){ ?>
 <li class="nav-item">
           <a href="callcard_admin.php" class="nav-link <?php if(basename($_SERVER['SCRIPT_NAME'])=='callcard_admin.php'){?> active<?php } ?>">
        <p><img src="images/icon_callcard.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("CallCard Admin"); ?></p>
     	 </a>
    </li>
...
<?php if ($SScontacts_enabled > 0){ ?>
 <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=190000000000" class="nav-link <?php if($ADD=='190000000000'){?> active<?php } ?>"><p><img src="images/icon_contacts.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Contacts"); ?></p></a></li>
<?php } ?>

<li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=192000000000" class="nav-link <?php if($ADD=='192000000000'){?> active<?php } ?>"><p><img src="images/icon_settingscontainer.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Settings Containers"); ?></p></a></li>

<?php if ($SSenable_auto_reports > 0){ ?>
 <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=194000000000" class="nav-link <?php if($ADD=='194000000000'){?> active<?php } ?>"><p><img src="images/icon_autoreports.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("Automated Reports"); ?></p></a></li>
<?php } ?>
<?php if ($SSallow_ip_lists > 0){ ?>
 <li class="nav-item"><a href="<?php echo $ADMIN ?>?ADD=195000000000" class="nav-link <?php if($ADD=='195000000000'){?> active<?php } ?>"><p><img src="images/icon_iplists.png" border=0 alt=\"Users\" width=16 height=16 valign=middle> <?php echo _QXZ("IP Lists"); ?></p></a></li>
<?php } ?>
       		 </ul>
          </li>
         ...
         <!-- ADMIN NAVIGATION -->
       <?php	
	   	//($reports_only_user < 1) and ($qc_only_user < 1)
	    }else
		{
			if ($reports_only_user > 0)
			{ 
		...
		?>
         ...
         <li class="nav-item <?php if ( ($ADD==100000000000000) or ($ADD==341111111111111) or (basename($_SERVER['SCRIPT_NAME'])=='qc_scorecards.php') ){?> menu-open<?php } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-link <?php if($ADD=='100000000000000'){?> active<?php } ?>">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p><?php echo _QXZ("Show QC Campaigns"); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-link <?php if($ADD=='100000000000000'){?> active<?php } ?>">
        ...
        <?php 	
		  ...
		  } //($reports_only_user < 1) and ($qc_only_user < 1) else end
		  ?> 
        </ul>
    </nav>
      <!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php  if ( ($ADD=='999988') or ($ADD=='999987') or ($ADD=='999986') )  {  ?>
         <div class="row mb-2">
          <div class="col-sm-12">
           <a href="admin.php?ADD=999988" class="btn btn-secondary"><?php echo _QXZ("Available Timezones"); ?> </a>&nbsp;&nbsp;
           <a href="admin.php?ADD=999987" class="btn btn-secondary"><?php echo _QXZ("Phone Codes"); ?> </a>&nbsp;&nbsp;
           <a href="admin.php?ADD=999986" class="btn btn-secondary"><?php echo _QXZ("Postal Codes"); ?> </a>
          </div>
        </div>
	...
	if ( (strlen($list_sh) > 25) and (strlen($campaigns_hh) > 25) ) { 
		?>
         ...
         <div class="row mb-2">
          <div class="col-sm-12">
           <a href="admin.php?ADD=10" class="btn btn-secondary"><?php echo _QXZ("Show Campaigns"); ?> </a>&nbsp;&nbsp;
           <?php if ($add_copy_disabled < 1) { ?>
           <a href="admin.php?ADD=11" class="btn btn-secondary"><?php echo _QXZ("Add A New Campaign"); ?> </a>&nbsp;&nbsp;
           <a href="admin.php?ADD=12" class="btn btn-secondary"><?php echo _QXZ("Copy Campaign"); ?> </a>&nbsp;&nbsp;
           <?php } ?>
		...
		?>
         <div class="row mb-2">
          <div class="col-sm-12">
           ...
           <?php if ($add_copy_disabled < 1) { ?>
           <a href="<?php echo $ADMIN ?>?ADD=11111111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Show VICIDIAL Conference"); ?> </a>&nbsp;&nbsp;
           <?php } ?>
