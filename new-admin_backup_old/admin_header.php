...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href=".agent/timeclock.php?referrer=admin" class="nav-link"><?php echo _QXZ("Timeclock"); ?></a>
      </li>
       <li class="nav-item d-none d-sm-inline-block">
      ...
      <?php if ($SSenable_languages == '1')	{ ?>
       <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo $ADMIN ?>?ADD=999989" class="nav-link"><?php echo _QXZ("Change language"); ?></a>
      </li>
      <?php } ?>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
<A HREF="admin.php"><IMG SRC="<?php echo $selected_logo; ?>" ALT="System logo" ><?php /*?>&nbsp;&nbsp;&nbsp;
